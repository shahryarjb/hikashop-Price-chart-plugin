...
function onHikashopAfterDisplayView(&$view) {
		...
		if ($cheak->get('option') == 'com_hikashop' AND $cheak->get('ctrl') == 'product' AND $cheak->get('task') == 'show') {
				...
				JHtml::script(JURI::root().'plugins/hikashop/pricechartpluginforhikashop/jquery.slModal.js'); 
				JHtml::stylesheet(JURI::root().'plugins/hikashop/pricechartpluginforhikashop/jquery.slModal.css'); 
